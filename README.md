...
[websrl@web-login htdocs-ait]$ cd ../website
```
Upload you files to the '???' directory. All files are then available under https://files.ait.inf.ethz.ch/ url. For example, file in '/import/vechev/h1/htdocs-srl/website/slides/deguard-androidsec17.pdf' is available at https://files.ait.inf.ethz.ch/website/slides/deguard-androidsec17.pdf
